...
#SBATCH -o RePaViT_small_BS1024_Both_Fixup_BatchNorm_PerOperation_ShortcutGain0.2+FinetuneAfter300Epochs_lr5e-4_warmuplr1e-6+warmup20epochs_minlr1e-6_out.txt
#SBATCH -e RePaViT_small_BS1024_Both_Fixup_BatchNorm_PerOperation_ShortcutGain0.2+FinetuneAfter300Epochs_lr5e-4_warmuplr1e-6+warmup20epochs_minlr1e-6_err.txt
